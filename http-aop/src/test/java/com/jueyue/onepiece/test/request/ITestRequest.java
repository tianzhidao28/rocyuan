...
public interface ITestRequest {
    ...
    @IRequestMethod(type=RequestTypeEnum.GET, url = "http://www.tuling123.com/openapi/api")
    String getTextFromTuling(@IRequestParam("location") String key,
                             @IRequestParam("location") String info);
